...
struct ContentView: View {
    ...
    @State private var editingItem: FlashtrackItem?
    ...
    private var emptyState: some View {
        VStack(spacing: 12) {
            ...
            Text("Tap + to add your first deck.")
                .font(Theme.captionFont)
                .foregroundStyle(Theme.textSecondary)
        }
    }

    private func row(for item: FlashtrackItem) -> some View {
        HStack {
            Button {
...
struct EditItemView: View {
    ...
    init(item: FlashtrackItem?, onSave: @escaping (String, String, Double, Date) -> Void) {
        self.item = item
        self.onSave = onSave
